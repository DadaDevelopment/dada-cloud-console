...
const termsRu: LegalDocData = {
  ...
  sections: [
    ...
    },
    {
      heading: "3. Тарифы",
      body: [
        "Бесплатный тариф включает: 1 приложение, 1 базу данных, 2 ГБ хранилища, 1 домен, 1 окружение и 1 участника команды; резервные копии на бесплатном тарифе не хранятся.",
