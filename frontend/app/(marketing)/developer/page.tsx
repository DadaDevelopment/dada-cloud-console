  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: ListTree,
        featured: true,
        title: { ru: "Справочник: все 41 инструмент", en: "Reference: all 41 tools" },
        desc: {
...
export default function DeveloperPage() {
  ...
  const copy = {
    ru: {
      ...
      guidesNote: "Тексты руководств пока только на английском.",
      buildTitle: "Автоматизация: REST API и MCP",
      apiTitle: "REST API",
      apiDesc: "Каждый ресурс консоли доступен через /api/v1 с авторизацией по токену.",
      mcpTitle: "MCP-сервер",
      mcpDesc: "41 инструмент для AI-агента: те же права, что у вашего аккаунта, вход через браузер.",
      ...
      faq: [
        { q: "Где документация DADA Cloud?", a: "На этой странице: раздел «Руководства» — пошаговые гайды по консоли, от первого деплоя до биллинга, ролей и подключения AI-агента по MCP. Тексты гайдов пока на английском." },
        ...
        { q: "Можно ли управлять облаком из AI-агента?", a: "Да. Кроме REST есть MCP-сервер: агент получает 41 инструмент и работает с проектами, приложениями, базами и логами теми же правами, что и ваш аккаунт. В разделе «AI-агенты (MCP)» выше — подключение, полный справочник инструментов и готовые сценарии." },
    ...
    en: {
      ...
      mcpTitle: "MCP server",
      mcpDesc: "41 tools for an AI agent: exactly your account's permissions, browser sign-in, no tokens in config files.",
      ...
      faq: [
        ...
        { q: "Can an AI agent drive the cloud?", a: "Yes. Besides REST there is an MCP server: the agent gets 41 tools and works with projects, apps, databases and logs under exactly the permissions your account has. The AI agents (MCP) section above has setup, the full tool reference and worked recipes." },
