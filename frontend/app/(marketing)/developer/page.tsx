  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: ListTree,
        featured: true,
        title: { ru: "Справочник: все 45 инструмента", en: "Reference: all 45 tools" },
        desc: {
...
export default function DeveloperPage() {
  ...
  const copy = {
    ru: {
      ...
      mcpTitle: "MCP-сервер",
      mcpDesc: "45 инструмента для AI-агента: те же права, что у вашего аккаунта, вход через браузер.",
      ...
      faq: [
        ...
        { q: "Можно ли управлять облаком из AI-агента?", a: "Да. Кроме REST есть MCP-сервер: агент получает 45 инструмента и работает с проектами, приложениями, базами и логами теми же правами, что и ваш аккаунт. В разделе «AI-агенты (MCP)» выше — подключение, полный справочник инструментов и готовые сценарии." },
    ...
    en: {
      ...
      mcpTitle: "MCP server",
      mcpDesc: "45 tools for an AI agent: exactly your account's permissions, browser sign-in, no tokens in config files.",
      ...
      faq: [
        ...
        { q: "Can an AI agent drive the cloud?", a: "Yes. Besides REST there is an MCP server: the agent gets 45 tools and works with projects, apps, databases and logs under exactly the permissions your account has. The AI agents (MCP) section above has setup, the full tool reference and worked recipes." },
