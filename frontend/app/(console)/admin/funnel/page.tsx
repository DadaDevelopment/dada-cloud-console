...
export default function AdminFunnelPage() {
  ...
  const lifecycleStreams: DetailedFunnelStream[] = lifecycle ? [
    ...
    { id: "first-deploy", label: t("adminFunnel.lifecycle.firstDeployStream"), color: "#ea580c", stages: [{ label: t("adminFunnel.lifecycle.appCreated"), value: lifecycle.app_creators, detail: t("adminFunnel.lifecycle.usersUnit") }, { label: t("adminFunnel.lifecycle.gitConnected"), value: lifecycle.git_connected_users, detail: t("adminFunnel.lifecycle.usersUnit") }, { label: t("adminFunnel.lifecycle.buildStarted"), value: lifecycle.build_started_users, detail: t("adminFunnel.lifecycle.usersUnit") }, { label: t("adminFunnel.lifecycle.firstDeployed"), value: lifecycle.first_deployed_users, detail: t("adminFunnel.lifecycle.usersUnit") }] },
