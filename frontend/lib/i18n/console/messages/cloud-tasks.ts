...
/** Cloud tasks panel on the app detail page (cloudTasks.*). */
export const cloudTasks: Messages = {
  "cloudTasks.title": { ru: "Задачи агента", en: "Agent tasks" },
  "cloudTasks.run": { ru: "Запустить: {label}", en: "Run: {label}" },
  "cloudTasks.starting": { ru: "Запуск…", en: "Starting…" },
  "cloudTasks.viewPR": { ru: "Открыть PR →", en: "View PR →" },
