...
export const adminFunnel: Messages = {
  ...
  "adminFunnel.acquisition.body": {
    ru: "Верхняя часть показывает источники и цели Метрики; нижняя — подтверждённые сервером аккаунты и первый авторизованный визит. Источники анонимны, поэтому граница между ними показана явно, без выдуманной конверсии.",
    en: "The top shows Metrika sources and goals; the bottom shows server-confirmed accounts and first authenticated visits. Sources are anonymous, so the boundary is explicit and does not invent conversion.",
  },
  ...
  "adminFunnel.lifecycle.body": {
    ru: "Историческая воронка по всем customer-аккаунтам. До Ready единица — пользователь; дальше — организация, потому что оплату хранит billing-организация. Ready — текущий срез, не дата первого успеха.",
    en: "Historical funnel for all customer accounts. The unit is a user through Ready, then an organization because payments belong to billing organizations. Ready is current state, not a first-success date.",
  },
