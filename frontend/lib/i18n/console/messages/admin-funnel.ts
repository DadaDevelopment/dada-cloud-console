...
export const adminFunnel: Messages = {
  ...
  "adminFunnel.lifecycle.firstDeployStream": { ru: "Основной путь до первого деплоя", en: "Main path to first deploy" },
  "adminFunnel.lifecycle.appCreated": { ru: "Создали App", en: "Created an App" },
  "adminFunnel.lifecycle.gitConnected": { ru: "Подключили Git", en: "Connected Git" },
  "adminFunnel.lifecycle.buildStarted": { ru: "Build начался", en: "Build started" },
  "adminFunnel.lifecycle.firstDeployed": { ru: "Первый deploy", en: "First deploy" },
