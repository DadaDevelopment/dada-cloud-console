...
export const apps: Messages = {
  ...
  "apps.config.subtitle": {
    ru: "Основные поля values.yaml (common). Правит values.yaml напрямую; для остального — редактор YAML.",
    en: "Core values.yaml (common) fields. Edits values.yaml directly; use the YAML editor for anything else.",
  },
  "apps.config.imageName": { ru: "Образ (name)", en: "Image (name)" },
  "apps.config.imageTag": { ru: "Тег образа (tag)", en: "Image tag" },
  ...
  "apps.config.useDotEnv": { ru: "useDotEnv", en: "useDotEnv" },
  ...
  "apps.config.reqCpu": { ru: "CPU (requests)", en: "CPU (requests)" },
  "apps.config.reqMemory": { ru: "Память (requests)", en: "Memory (requests)" },
  "apps.config.limCpu": { ru: "CPU (limits)", en: "CPU (limits)" },
  "apps.config.limMemory": { ru: "Память (limits)", en: "Memory (limits)" },
