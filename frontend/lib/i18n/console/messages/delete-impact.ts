...
export const deleteImpact: Messages = {
  ...
  "deleteImpact.loading": { ru: "Проверяем ресурсы…", en: "Scanning resources…" },
  ...
  "deleteImpact.source.clusterOnly": { ru: "только на платформе", en: "platform-only" },

  "deleteImpact.banner.clusterOnly": {
    ru: "Эти ресурсы есть на платформе, но консоль их не отслеживала — при удалении они тоже будут удалены.",
    en: "These resources exist on the platform but the console never tracked them — deleting will remove them too.",
  },
  "deleteImpact.banner.noScan": {
    ru: "Не удалось просканировать ресурсы — список может быть неполным.",
    en: "Resources could not be scanned — this list may be incomplete.",
  },
