...
const ru: Dict = {
  ...
  home: {
    ...
    mcp: {
      ...
      bullets: [
        "43 инструмента платформы прямо в чате",
  ...
  mcpAlt: {
    ...
    heroSubtitle:
      "Подключите платформу к Claude Code, Claude Desktop, Cursor или любому MCP-клиенту — и просите словами: подними сервер, разверни репозиторий, покажи логи упавшего приложения. Агент получает 43 инструмента консоли, входит под вашим аккаунтом DADA ID через браузер и работает ровно с теми правами, что есть у вас. Адрес сервера — https://console.dada-tuda.ru/mcp.",
    ...
    features: [
      { title: "43 инструмента платформы", desc: "Проекты, приложения, сборки, базы, домены, переменные окружения, серверы, логи и одноразовые песочницы-боксы — тот же API, на котором работает веб-консоль, отобранный до набора, в котором агент не теряется." },
...
const en: Dict = {
  ...
  home: {
    ...
    mcp: {
      ...
      bullets: [
        "43 platform tools right in the chat",
  ...
  mcpAlt: {
    ...
    heroSubtitle:
      "Connect the platform to Claude Code, Claude Desktop, Cursor or any MCP client and ask in plain language: spin up a server, deploy this repo, show me why the app is down. The agent gets 43 console tools, signs in as you through the browser, and works with exactly the permissions your account has. Server URL: https://console.dada-tuda.ru/mcp.",
    ...
    features: [
      { title: "43 platform tools", desc: "Projects, apps, builds, databases, domains, environment variables, servers, logs and throwaway sandbox boxes — the same API the web console runs on, cut down to a set an agent does not get lost in." },
