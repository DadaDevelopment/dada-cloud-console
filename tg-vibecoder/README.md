...
**Live:** (ещё не задеплоен — чат обсуждений канала не назначен)
...
| `evals/persona/` | 24 кейса золотого набора, 16 dev / 8 holdout |
...
- не выбран чат обсуждений и не выписан токен бота;
- бейкофф не прогнан: нужны ключи моделей;
- стадии в Jenkins, которая роняет сборку по эвалам, пока нет.
