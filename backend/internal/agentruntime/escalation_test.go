...
func TestPGEscalate_PausesNotifiesOperatorAndSyncsCRM(t *testing.T) {
	...
	status, result := postRuntime(t, httpServer.URL, "/tools/escalate", map[string]any{"context_token": token, "reason_code": "e_distrust", "summary": "Хочет пруфы доходности, злится."}, testRuntimeToken)
	...
	require.Contains(t, out.texts[0], "🔺 Эскалация")
	require.Contains(t, out.texts[0], "@client · Иван · tg://user?id=1001")
