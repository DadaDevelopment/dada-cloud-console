...
func buildAgentChatSystemPrompt(catalog []string) string {
	...
	sb.WriteString("Ask which one it is in a single plain question (\"is the code on GitHub, or is it a folder on your computer?\") rather than asking twice for a repository link the user may not have. ")
