    ...
    "paths": {
        ...
        "/projects/{projectId}/environments/{envId}/apps/{appName}/volume/maintenance/compact": {
            "get": {
                ...
                "operationId": "getAppVolumeMaintenanceCompact",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Project UUID",
                    ...
                    {
                        "type": "string",
                        "description": "Directory that was (or will be) packed, relative to the volume root",
                        "name": "path",
                        "in": "query",
                        "required": true
                    }
                ...
                "responses": {
                    "200": {
                        "description": "object with status, and on status=succeeded also files_packed/archive_path/archive_bytes/inodes_free_before/inodes_free_after/inodes_freed/finished_at; on status=failed also reason and hint",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
            ...
            "post": {
                ...
                "operationId": "createAppVolumeMaintenanceCompact",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Project UUID",
                    ...
                    {
                        "description": "Directory to pack, relative to the volume root",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.volumeCompactRequest"
                        }
                    }
                ],
                "responses": {
